    ...
    shiny::tabPanel("Price", value = "price",
      info_panel(
        ...
        shiny::tags$p("Results show the expected loss, risk measures and two",
          ...
          " closed-form figure as a sanity check. The MC std error column sizes",
          " the simulation noise: a delta within about two standard errors is",
          " noise, a larger one is worth investigating.",
